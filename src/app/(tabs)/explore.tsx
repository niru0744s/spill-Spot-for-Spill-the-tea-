/**
 * (tabs)/explore.tsx — Coming Soon placeholder
 */
  ...
  return (
    <View style={styles.container}>
      <Animated.View style={[styles.iconWrapper, { transform: [{ translateY: floatAnim }] }]}>
        <MaterialIcons name="explore" size={56} color="#7adc7d" />
      </Animated.View>
      <Text style={styles.title}>Explore</Text>
      <Text style={styles.subtitle}>Coming soon — discover new connections{'\n'}and trending tea ☕</Text>
...
const styles = StyleSheet.create({
  ...
  pill: {
    ...
    borderWidth: 1,
    borderColor: 'rgba(122,220,125,0.25)',
    borderRadius: 9999,
